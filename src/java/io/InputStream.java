...
public abstract class InputStream implements Closeable {
    ...
    // use when skipping.
    // MAX_SKIP_BUFFER_SIZE 用来决定跳过的最大缓存
    private static final int MAX_SKIP_BUFFER_SIZE = 2048; // 2k
     ...
     * {@code close()} method.  Subsequent（随后的; 后来的; 之后的; 接后的;） calls to {@code close()} have no
     * effect.
     *
     ...
     * @return the number of bytes transferred 传递的字节数
