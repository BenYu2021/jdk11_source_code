    ...
    implements Serializable, Comparable<File>
{
    ...
    /**
     * 检测文件路径是否无效，目前文件路径的检测非常有限，它只包括Nul字符（值为0的字符）检查。
     * 返回true表示路径绝对无效/垃圾，但返回false并不保证路径有效
     *
     ...
     *          SecurityManager#checkRead} method denies
     ...
     *
     * <blockquote><code>
     * new {@link #File(URI) File}(</code><i>&nbsp;f</i><code>.toURI()).equals(
     ...
     * @throws  SecurityException
     *          If a security manager exists and its {@link
     *          SecurityManager#checkDelete} method denies
     ...
     * is equivalent to invoking {@link #createTempFile(String,
     * String, File)
