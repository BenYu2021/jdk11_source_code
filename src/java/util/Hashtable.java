...
public class Hashtable<K,V>
     ...
     */
    /***
     * Hashtable被结构性修改的次数（entries的数量发生变化，或者内部结构发生变化，比如rehash）。
     * 此字段用于使哈希表的集合视图上的迭代器快速失败。
     */
    ...
    public Hashtable(Map<? extends K, ? extends V> t) {
        this(Math.max(2*t.size(), 11), 0.75f);  // 按照参数初始化对象
        putAll(t);
    }
     ...
     *
     * @param dummy a dummy假的 parameter
     */
     ...
     * {@link ConcurrentModificationException} if the mapping
     ...
     *
     * <p>This method will, on a best-effort basis, throw a
     * {@link ConcurrentModificationException} if the remapping
     * function modified this map during computation.
     *
     * @throws ConcurrentModificationException if it is detected that the
     ...
     */
    final void defaultWriteHashtable(ObjectOutputStream s, int length,
    ...
    /**
     * A hashtable enumerator class.  This class implements both
