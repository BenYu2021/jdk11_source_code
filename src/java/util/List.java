...
public interface List<E> extends Collection<E> {
    ...
    /***
     * ArrayList<T>使用的equals方法将返回true，如果以相同顺序传递具有相同元素的LinkedList<T>。
     * 因此，如果您有List<ArrayList<Integer>>，则可以通过调用lastIndexOf来传递LinkedList<Integer>，
     * 以便找到相同的ArrayList<Integer>。但如果lastIndexOf按照您描述的方式定义，则这是不可能的。
     * @param o
     * @return
     */
