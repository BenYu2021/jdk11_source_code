...
class Thread implements Runnable {
    ...
    private boolean daemon = false; // 线程是否是守护线程
    ...
    /***
     * 线程优先级1-10，默认优先级 NORM_PRIORITY 为 5
     */
    /**
     * The minimum priority that a thread can have.
     */
    public static final int MIN_PRIORITY = 1;   // 线程的最低优先级
   ...
   /**
    ...
    throws InterruptedException {
        ...
        /**
         * nanos[500000,999999)或者 millis为0，nanos（0， 500000）时， millis为0直接+1
         */
